...
$controller = 'index';
ini_set('session.cookie_lifetime', 0); // que se elimine la cookie automáticamente
ini_set('session.cookie_httponly', true); //evitar robo por inyeccion de javascript
